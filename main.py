...
MY_GUILD = discord.Object(id=864441968776052747)  # replace with your guild id
...
class MyClient(commands.Bot):
    ...
    async def setup_hook(self):
        ...
        await client.load_extension(f"cogs.test")
...
client = MyClient(intents=intents, application_id=942214717945036820)
