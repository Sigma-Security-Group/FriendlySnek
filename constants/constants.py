...
DOCUMENTATION = 845107987702087680
FAQ = 785329746531319818
...
RANK_STRUCTURE = 945392557129609327
...
TROUT = "<:trout:1445127540267286558>"
...
PROMOTION_RECOMMENDATION_SOURCE_RANKS = (
    VERIFIED,
    CANDIDATE,
    ASSOCIATE,
    CONTRACTOR,
...
PROMOTION_RECOMMENDATION_ALLOWED_TARGETS = {
    VERIFIED: (CANDIDATE,),
    CANDIDATE: (ASSOCIATE,),
    ASSOCIATE: (CONTRACTOR,),
    CONTRACTOR: (MERCENARY, TACTICIAN),
    MERCENARY: (OPERATOR, TACTICIAN),
    OPERATOR: (TACTICIAN,),
    TACTICIAN: (STRATEGIST, MERCENARY),
    STRATEGIST: (MERCENARY,),
}

PROMOTION_RECOMMENDATION_MINIMUM_RECOMMENDER_ROLES = {
    CANDIDATE: (ASSOCIATE, CONTRACTOR, MERCENARY, OPERATOR, TACTICIAN, STRATEGIST, ADVISOR, UNIT_STAFF),
    ASSOCIATE: (CONTRACTOR, MERCENARY, OPERATOR, TACTICIAN, STRATEGIST, ADVISOR, UNIT_STAFF),
    CONTRACTOR: (MERCENARY, OPERATOR, TACTICIAN, STRATEGIST, ADVISOR, UNIT_STAFF),
    MERCENARY: (OPERATOR, STRATEGIST, ADVISOR, UNIT_STAFF),
    TACTICIAN: (OPERATOR, STRATEGIST, ADVISOR, UNIT_STAFF),
    OPERATOR: (ADVISOR, UNIT_STAFF),
    STRATEGIST: (ADVISOR, UNIT_STAFF),
}
